...
export const agentTemplates: AgentTemplate[] = [
  ...
  },
  {
    ...
    toolIds: ['read', 'glob', 'grep', 'rg', 'git_status', 'git_diff', 'file_info', 'validate', 'review_finding', 'ToolSearch', 'websearch'],
    accent: 'violet',
  },
  {
    id: 'debug-agent',
    ...
    toolIds: ['read', 'glob', 'grep', 'rg', 'git_status', 'git_diff', 'apply_patch', 'validate', 'debug_evidence', 'bash', 'background_run', 'check_background', 'write_stdin', 'ToolSearch', 'todowrite', 'question', 'skill'],
    accent: 'amber',
  },
  {
    id: 'research-analyst',
